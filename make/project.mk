...
help:
	...
	@echo ""
	@echo "make all - Build app, partition table"
	@echo "make flash - Flash app, partition table to a chip"
...
NONOS_SDK_DIR = $(BUILD_DIR_BASE)/nonos-sdk/sdk

# Set default LDFLAGS
EXTRA_LDFLAGS ?=
ENTRY_POINT ?= call_user_start
LD_SCRIPT ?= $(NONOS_SDK_DIR)/ld/eagle.app.v6.ld
LDFLAGS ?= -nostdlib \
	-u $(ENTRY_POINT)	\
	-e $(ENTRY_POINT) \
	-T $(LD_SCRIPT) \
...
# NB: this ordering is deliberate (app-clean before
# _config-clean), so config remains valid during all component clean
# targets
config-clean: app-clean
clean: app-clean config-clean ldgen-clean
